...
from ursina import  *
from ursina.prefabs.first_person_controller import FirstPersonController              #must import seperatly not imported with the rest of ursina
...
class Voxel(Button):                                                                       
    def __init__(self, position = (0,0,0), texture = grass_texture):
        super().__init__(
            ...
            model = 'assets/block',
            origin_y = 0.5,
            texture = texture,                       #texture needs to be lowercase t or it wont load the texture
